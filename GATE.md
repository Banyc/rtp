...
re-measured here at 3.00-3.01 s); the two decoder fuzzes are next at 1.84 s and 1.85 s,
and the watchdog row this paragraph used to place between them and the 3.00 s pair
now costs 1.20 s, below
